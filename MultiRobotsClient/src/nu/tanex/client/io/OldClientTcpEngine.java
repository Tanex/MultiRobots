 ...
 * @see ClientTcpEngine
 */
public class OldClientTcpEngine extends Thread {
     ...
     */
    public OldClientTcpEngine() throws TcpEngineException, UnknownHostException {
     ...
     */
    public OldClientTcpEngine(InetAddress address, int port) throws TcpEngineException {
        try {
